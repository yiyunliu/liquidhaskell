...
empty
    :: { bs : Data.ByteString.Short.ShortByteString | sbslen bs == 0 }

null
    :: bs : Data.ByteString.Short.ShortByteString
    -> { b : GHC.Types.Bool | Prop b <=> sbslen bs == 0 }

length
    :: bs : Data.ByteString.Short.ShortByteString -> { n : GHC.Types.Int | sbslen bs == n }

index
    :: bs : Data.ByteString.Short.ShortByteString
    -> { n : GHC.Types.Int | 0 <= n && n < sbslen bs }
    -> Data.Word.Word8
